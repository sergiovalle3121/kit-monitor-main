  ...
  return (
    <DepartmentWorkspace
      ...
      tools={[
        ...
        { title: 'Forecast y simulación', desc: 'Escenarios y Monte Carlo', href: '/dashboard/forecast', icon: LineChart, color: 'text-indigo-500', tint: 'bg-indigo-50 dark:bg-indigo-500/10' },
