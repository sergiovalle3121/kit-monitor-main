  ...
  return (
    <DepartmentWorkspace
      ...
      tools={[
        ...
        { title: 'Forecast y simulación', desc: 'Monte Carlo, escenarios y capacidad', href: '/dashboard/forecast', icon: LineChart, color: 'text-primary', tint: 'bg-primary dark:bg-primary/10' },
