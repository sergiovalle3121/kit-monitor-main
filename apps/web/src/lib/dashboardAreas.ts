...
export const AREAS: DashboardArea[] = [
  // ── Diseño · NPI ──
  { name: "Modelos · NPI", desc: "Maestro de productos · gates y readiness", href: "/dashboard/models", icon: Boxes, domain: "engineering", roles: ["engineering", "industrial_engineer", "quality_engineer", "production_supervisor"], section: "Diseño · NPI" },
