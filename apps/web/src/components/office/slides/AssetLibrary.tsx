  ...
  return (
    <div className="w-[360px] p-3 space-y-3">
      ...
      <div className="grid grid-cols-2 gap-2 max-h-[330px] overflow-y-auto pr-1">
        {filtered.map((asset) => (
          <button key={asset.id} onClick={() => onPick(asset)} className="group text-left rounded-xl border border-black/10 dark:border-white/10 p-2 hover:border-blue-400 hover:bg-blue-50/50 dark:hover:bg-blue-500/10 transition-colors">
