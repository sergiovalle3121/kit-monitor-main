...
@Module({
  imports: [TypeOrmModule.forFeature([OfficeDocument, OfficeDocumentVersion, OfficeDocumentComment, OfficeDocumentSearchIndex, OfficeDocumentDistribution, OfficeDocumentSignature, OfficeDocumentTrainingAssignment, OfficeDocumentReviewTask]), GovernanceModule],
